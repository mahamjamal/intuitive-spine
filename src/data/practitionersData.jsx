const practitioners = [
  {
    ...
    availability: [
      { day: "Monday", time: "Daytime (varies)" },
      { day: "Tuesday", time: "Daytime (varies)" },
      { day: "Wednesday", time: "Daytime (varies)" },
      {
        day: "Thursday",
        time: "7:00 pm – 9:00 pm or daytime depending on shifts",
      },
      { day: "Friday", time: "Daytime (varies)" },
  ...
  {
    id: 3,
    name: "Linda Belenczuk",
    title:
      "Certified Spinal Flow Practitioner | Member, Spinal Flow Technique Association",
    image: null,
    bio: "Linda Belenczuk is a dedicated Spinal Flow Practitioner passionate about helping others experience true healing and alignment from within. With a compassionate approach and deep understanding of the nervous system, she guides clients through gentle, powerful sessions that release stress, open healing gateways, and reconnect the body to its innate intelligence.",
    availability_notes: "Regular weekly schedule.",
    availability: [
      { day: "Monday", time: "4:00 pm – 7:00 pm" },
      { day: "Wednesday", time: "1:00 pm – 4:00 pm, 5:00 pm – 8:00 pm" },
